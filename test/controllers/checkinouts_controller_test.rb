...
class CheckinoutsControllerTest < ActionController::TestCase
  ...
  test "should create checkinout" do
    assert_difference('Checkinout.count') do
      post :create, checkinout: { checkin: @checkinout.checkin, checkout: @checkinout.checkout, rec_date: @checkinout.rec_date, ref_time: @checkinout.ref_time, user_id: @checkinout.user_id }
    end
  ...
  test "should update checkinout" do
    patch :update, id: @checkinout, checkinout: { checkin: @checkinout.checkin, checkout: @checkinout.checkout, rec_date: @checkinout.rec_date, ref_time: @checkinout.ref_time, user_id: @checkinout.user_id }
    assert_redirected_to checkinout_path(assigns(:checkinout))
  end
