...
ActiveRecord::Schema.define(version: 20190221073818) do
  ...
  create_table "approves", force: :cascade do |t|
    ...
    t.string   "approveable_type", limit: 255
  end
  ...
  add_index "assaults", ["user_id"], name: "index_assaults_on_user_id", using: :btree
  ...
  create_table "em_ser_cates", force: :cascade do |t|
    t.string   "name",       limit: 30
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
  end

  create_table "em_services", force: :cascade do |t|
    t.string   "title",          limit: 255
    t.text     "content",        limit: 65535
    t.integer  "em_ser_cate_id", limit: 4
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
  end

  add_index "em_services", ["em_ser_cate_id"], name: "index_em_services_on_em_ser_cate_id", using: :btree
